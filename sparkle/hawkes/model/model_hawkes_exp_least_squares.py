...
from sparkle.hawkes.model.build.hawkes_model import ModelHawkesExpLeastSquares as CppModelHawkesExpLeastSquares
...
class ModelHawkesExpLeastSquares(ModelHawkes):
    ...
    * :math:`\\beta` is the fixed and given decay of the exponential kernel 
    ...
    See Also
    --------
    :class:`~sparkle.hawkes.model.ModelHawkesExpLogLikelihood` : model class 
