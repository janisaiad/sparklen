...
from sparkle.hawkes.model.build.hawkes_model import ModelHawkesExpLogLikelihood as CppModelHawkesExpLogLikelihood

from sparkle.hawkes.model.base.model_hawkes import ModelHawkes
...
class ModelHawkesExpLogLikelihood(ModelHawkes):
    ...
    * :math:`\\beta` is the fixed and given decay of the exponential kernel
    ...
    See Also
    --------
    :class:`~sparkle.hawkes.model.ModelHawkesExpLeastSquares` : model class
