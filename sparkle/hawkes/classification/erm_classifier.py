...
from sparkle.hawkes.model import ModelHawkesExpClassification

from sparkle.hawkes.model.build.hawkes_model import ModelHawkesExpLogLikelihoodSingle as CppModelHawkesExpLogLikelihoodSingle

from sparkle.plot import plot_confusion_matrix
...
class ERMCLassifier():
    ...
    * :math:`Y^{(i)} \\in [K]` is the label of the :math:`i`-th feature  
    ...
    def plot_score_cm(self, X, y, end_time, save_path=None, save_format='png', dpi=300, use_latex=False):
        ...
        This method calls the plot function :function:`~sparkle.plot.plot_hawkes.plot_confusion_matrix`
