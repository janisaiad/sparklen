...
from sparkle.hawkes.model import ModelHawkesExpLeastSquares, ModelHawkesExpLogLikelihood

from sparkle.prox import ProxZero, ProxL1, ProxL2, ProxElasticNet

from sparkle.optim.optimizer import GD, AGD

from sparkle.optim.lr import LipschitzLR, BacktrackingLineSearchLR

from sparkle.calibration import CalibrationCV, CalibrationEBIC

from sparkle.plot import plot_values, plot_support
...
class LearnerHawkesExp():
    ...
    * :math:`\\kappa` is the regularization constant
    ...
    def plot_estimated_values(self, save_path=None, save_format='png', dpi=300, use_latex=False):
        ...
        This method calls the plot function :function:`~sparkle.plot.plot_hawkes.plot_values`
    ...
    def plot_estimated_support(self, save_path=None, save_format='png', dpi=300, use_latex=False):
        ...
        This method calls the plot function :function:`~sparkle.plot.plot_hawkes.plot_support`
